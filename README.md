...
## ⚙️ How It Works
* **Data Ingestion** — Users upload up to four static CSV/JSON datasets strictly mapped to the system's expected payload: `envGeoData`, `bioCropData`, `operationsData`, and `financialData`.
