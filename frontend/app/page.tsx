      ...
      <div style={{ display:'flex', flexDirection:'column', height:'100vh', background:'#f2f7f4', color:'#1a3a28', fontFamily:"'Sora',sans-serif", overflow:'hidden' }}>
        ...
        <header style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'0 32px', height:60, background:'#fff', borderBottom:'1px solid #e4ede8', zIndex:20, flexShrink:0 }}>
          ...
          <div style={{ display:'flex', gap:12, alignItems:'center' }}>
            ...
            <div style={{ textAlign: 'center', background: hasMounted && stats.runway < 100 ? '#fffbeb' : '#edfaf4', border: `1px solid ${hasMounted && stats.runway < 100 ? '#fde68a' : '#a7f3d0'}`, borderRadius: 12, padding: '7px 16px' }}>
        ...
        <main style={{ flex:1, overflowY:'auto', padding:'26px 32px' }}>
          ...
          {activeTab === 'page1' && (
            <div className="tab-content" style={{ maxWidth:1100, margin:'0 auto', display:'flex', flexDirection:'column', gap:24 }}>
              ...
              {/* ── SECTION 1: Critical Action Recommended ── */}
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:36 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display:'flex', flexDirection:'column', gap:0 }}>
                      {[
                        { label:'Wind Speed', value:'22 km/h', sub:'Rising', valueColor:'#d97706', borderBottom:true },
                        { label:'Barometric Pressure', value:'1008 hPa', sub:'Dropping', valueColor:'#1a3a28', borderBottom:true },
                        { label:'Solar Radiation', value:'750 W/m²', sub:'', valueColor:'#059669', borderBottom:false },
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20 }}>
                <div style={{ display:'flex', flexDirection:'column', gap:18 }}>
                  <div style={card}>
                    ...
                    {[
                      { key:'fert' as const, label:'Fertilizer Input', unit:'kg/ha', min:200, max:800, zone:[300,650] },
                      { key:'labor' as const, label:'Extra Labor Hours', unit:'hours', min:0, max:300, zone:[0,200] },
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20 }}>
                ...
                <div style={{ ...card, display:'flex', flexDirection:'column', gap:0 }}>
                  <div style={{ display:'flex', alignItems:'center', gap:9, marginBottom:20 }}>
                    ...
                    <div>
                      <div style={{ fontSize:14, fontWeight:700, color:'#0f2d1e', lineHeight:1.2 }}>Bio Asset Health & Growth Curve</div>
                      <div style={{ fontSize:11, color:'#8aac98', marginTop:2 }}>Simulate how input changes affect bio asset value</div>
                    </div>
                  </div>
                  <SimSlider label="Fertilizer Reduction" unit="%" min={0} max={40} value={bioFertReduction} onChange={setBioFertReduction} zone={[0, 15]} formatVal={v => `${v}%`} />
                  <SimSlider label="Irrigation Frequency" unit="times/week" min={1} max={7} value={bioIrrigation} onChange={setBioIrrigation} zone={[3, 5]} />
                  <div style={{ borderTop:'1px solid #f0f7f3', paddingTop:16, marginTop:4 }}>
                    <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:14 }}>
                      <HealthGauge value={bioHealthIndex} size={82} />
                      <div style={{ flex:1 }}>
                        <div style={{ fontSize:10, color:'#8aac98', fontWeight:700, letterSpacing:'0.1em', textTransform:'uppercase' as const, marginBottom:6 }}>Bio Health Index (BHI)</div>
                        <div style={{ fontFamily:"'JetBrains Mono',monospace", fontSize:28, fontWeight:800, color:bioHealthColor, lineHeight:1 }}>{bioHealthIndex}<span style={{ fontSize:13, opacity:0.6 }}>/100</span></div>
                        <div style={{ fontSize:11, color:bioHealthColor, fontWeight:700, marginTop:4 }}>
                          {bioHealthIndex >= 75 ? '✓ Healthy & Stable' : bioHealthIndex >= 55 ? '⚠ Mild Stress' : '⛔ Critical Loss'}
                        </div>
                      </div>
                    </div>
                    <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
